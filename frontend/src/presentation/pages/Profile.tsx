...
export const Profile: React.FC = () => {
  ...
  const [editForm, setEditForm] = useState({
    ...
    email: "", bio: "", country: "", city: "", state: "", language: "",
  });
  ...
  const handleSaveProfile = async () => {
    ...
    const required = ["first_name", "display_name", "username", "country", "state", "city", "language"];
              ...
              {activeTab === "edit" && (
                <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex gap-2">
                        ...
                        {!avatarFile ? (
                          ...
                          <>
                            <Button size="sm" isLoading={uploadingAvatar} onClick={handleUploadAvatar}>Upload</Button>
                  ...
                  <div className="pt-4 border-t border-borderToken flex justify-end gap-3 mt-4">
                    ...
                    <Button onClick={handleSaveProfile} isLoading={savingProfile} className="gap-2">
